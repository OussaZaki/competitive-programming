/**
 * C++ solution for Day20 - Advent of code 2018
 *
...
int day20_part1(vector<int> input)
{
  
  return 0;
}

int day20_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day20_part1(input) << endl;
  cout << day20_part2(input) << endl;
}
