/**
 * C++ solution for Day10 - Advent of code 2018
 *
...
int day10_part1(vector<int> input)
{
  
  return 0;
}

int day10_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day10_part1(input) << endl;
  cout << day10_part2(input) << endl;
}
