/**
 * C++ solution for Day8 - Advent of code 2018
 *
...
int day8_part1(vector<int> input)
{
  
  return 0;
}

int day8_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day8_part1(input) << endl;
  cout << day8_part2(input) << endl;
}
