/**
 * C++ solution for Day24 - Advent of code 2018
 *
...
int day24_part1(vector<int> input)
{
  
  return 0;
}

int day24_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day24_part1(input) << endl;
  cout << day24_part2(input) << endl;
}