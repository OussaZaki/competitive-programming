/**
 * C++ solution for Day23 - Advent of code 2018
 *
...
int day23_part1(vector<int> input)
{
  
  return 0;
}

int day23_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day23_part1(input) << endl;
  cout << day23_part2(input) << endl;
}
