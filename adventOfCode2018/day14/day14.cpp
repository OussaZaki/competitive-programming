/**
 * C++ solution for Day14 - Advent of code 2018
 *
...
int day14_part1(vector<int> input)
{
  
  return 0;
}

int day14_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day14_part1(input) << endl;
  cout << day14_part2(input) << endl;
}
