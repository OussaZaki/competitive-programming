/**
 * C++ solution for Day7 - Advent of code 2018
 *
...
int day7_part1(vector<int> input)
{
  
  return 0;
}

int day7_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day7_part1(input) << endl;
  cout << day7_part2(input) << endl;
}
