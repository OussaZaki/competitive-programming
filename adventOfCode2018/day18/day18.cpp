/**
 * C++ solution for Day18 - Advent of code 2018
 *
...
int day18_part1(vector<int> input)
{
  
  return 0;
}

int day18_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day18_part1(input) << endl;
  cout << day18_part2(input) << endl;
}
