/**
 * C++ solution for Day25 - Advent of code 2018
 *
...
int day25_part1(vector<int> input)
{
  
  return 0;
}

int day25_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day25_part1(input) << endl;
  cout << day25_part2(input) << endl;
}
