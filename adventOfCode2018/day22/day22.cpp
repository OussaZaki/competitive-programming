/**
 * C++ solution for Day22 - Advent of code 2018
 *
...
int day22_part1(vector<int> input)
{
  
  return 0;
}

int day22_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day22_part1(input) << endl;
  cout << day22_part2(input) << endl;
}
