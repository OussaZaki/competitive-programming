/**
 * C++ solution for Day17 - Advent of code 2018
 *
...
int day17_part1(vector<int> input)
{
  
  return 0;
}

int day17_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day17_part1(input) << endl;
  cout << day17_part2(input) << endl;
}
