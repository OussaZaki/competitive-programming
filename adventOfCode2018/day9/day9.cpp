/**
 * C++ solution for Day9 - Advent of code 2018
 *
...
int day9_part1(vector<int> input)
{
  
  return 0;
}

int day9_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day9_part1(input) << endl;
  cout << day9_part2(input) << endl;
}
