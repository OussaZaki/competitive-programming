/**
 * C++ solution for Day19 - Advent of code 2018
 *
...
int day19_part1(vector<int> input)
{
  
  return 0;
}

int day19_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day19_part1(input) << endl;
  cout << day19_part2(input) << endl;
}
