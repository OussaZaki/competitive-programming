/**
 * C++ solution for Day12 - Advent of code 2018
 *
...
int day12_part1(vector<int> input)
{
  
  return 0;
}

int day12_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day12_part1(input) << endl;
  cout << day12_part2(input) << endl;
}
