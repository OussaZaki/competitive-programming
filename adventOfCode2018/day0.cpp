/**
 * C++ solution for Day0 - Advent of code 2018
 *
 * link - https://adventofcode.com/2018/day/#0
...
int day0_part1(vector<int> input)
{
  
  return 0;
}

int day0_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day0_part1(input) << endl;
  cout << day0_part2(input) << endl;
}