/**
 * C++ solution for Day13 - Advent of code 2018
 *
...
int day13_part1(vector<int> input)
{
  
  return 0;
}

int day13_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day13_part1(input) << endl;
  cout << day13_part2(input) << endl;
}
