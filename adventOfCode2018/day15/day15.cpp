/**
 * C++ solution for Day15 - Advent of code 2018
 *
...
int day15_part1(vector<int> input)
{
  
  return 0;
}

int day15_part2(vector<int> input)
{
...
int main()
{
  ...
  cout << day15_part1(input) << endl;
  cout << day15_part2(input) << endl;
}
